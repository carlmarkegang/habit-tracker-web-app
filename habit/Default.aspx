...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <h4>
            ...
            <input type="text" id="datepicker" style="cursor: pointer; background-color: #f0ece3; border: 0px;" title="Click here to change date"> <a id="startdatesubmit" style="display:none;" href="#">Start!</a>
        </h4>
        <div id="rectangles">
        </div>
    </div>

    <div id="rectangles_submenu">
